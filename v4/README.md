...
- **ロゴを約130%に拡大**: 44vw→59vw（最大 164px→228px / 390px幅で 176px→228px）。この大きさでロゴ内の「KARA KARA SPICY RAMEN」がスマホでも読めるようになる。140%超は円が左右に迫り、背景イラスト（波・燕）を潰し始めるため130%を採用。縦の短い端末（高さ700px未満）は 46vw / 最大184pxに縮小して、ファーストビューに全要素が収まるようにしている。
- hero gap 24px→16px
