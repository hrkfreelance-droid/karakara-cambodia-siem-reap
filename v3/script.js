...
(function () {
  ...
  /* The scrim lives in CSS (layered, very weak gradients); this only points
     the image layer at the supplied artwork. */
  function setupBackground() {
    var background = document.querySelector(".site-background__image");
